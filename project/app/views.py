...
SAML2_RESPONSE = """
<samlp:Response xmlns:samlp="urn:oasis:names:tc:SAML:2.0:protocol" xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion" ID="_8e8dc5f69a98cc4c1ff3427e5ce34606fd672f91e6" Version="2.0" IssueInstant="%s" Destination="%s" InResponseTo="ONELOGIN_4fee3b046395c4e751011e97f8900b5273d56685">
...
def home(request):
    ...
    saml2_response = SAML2_RESPONSE % (issue_instant, destination, issue_instant)
